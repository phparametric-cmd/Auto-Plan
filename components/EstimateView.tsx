    ...
    <div id="estimate-doc-root" className="flex flex-col gap-12 text-slate-900 p-16 font-sans bg-white pb-24" style={{ width: '850px' }}>
      ...
      <div className="bg-slate-50 p-8 rounded-[32px] border border-slate-100">
        <p className="text-[11px] font-medium text-slate-500 leading-relaxed italic text-center">
          Данный расчет носит предварительный характер. Итоговая стоимость определяется индивидуально для каждого проекта с учетом архитектурных решений, участка и выбранных материалов.<br/><br/>
          <span className="font-bold text-slate-700">В стоимость чернового строительства входит:</span><br/>
          устройство фундамента согласно СНиП;<br/>
          закладка инженерных коммуникаций (водопровод и канализация) в фундаменте;<br/>
          колонно-ригельная конструктивная система;<br/>
          межэтажные монолитные перекрытия;<br/>
          монолитная лестница;<br/>
          наружные стены на выбор: газобетон, красный кирпич, финблок, полистиролбетон или монолит;<br/>
          внутренние перегородки;<br/>
          высота потолков — 3,2 м;<br/>
          кровля из металлочерепицы (цвет на выбор) со снегозадержателями;<br/>
          выполнение всех фасадных работ;<br/>
          установка окон;<br/>
          базовое благоустройство территории.<br/><br/>
          В стоимость включены все работы и материалы, а также доставка, спецтехника, оснащение строительной бригады и вывоз строительного мусора.<br/>
          Стоимость включает полный конструктив и внешний контур дома — всё, кроме внутренней отделки.
        </p>
      </div>
